...
export const metadata: Metadata = {
  title: "برنامج محاسبة للإمارات | ضريبة القيمة المضافة 5% | محاسب اي",
  description:
...
const FAQS = [
  { q: "هل محاسب اي يحسب ضريبة القيمة المضافة 5% للإمارات؟", a: "نعم، يحسب ضريبة القيمة المضافة تلقائياً بنسبة 5% على المبيعات والمشتريات ويُعدّ الإقرار الضريبي الفصلي جاهزاً للمراجعة." },
  { q: "هل البرنامج مناسب للشركات الصغيرة في دبي وأبوظبي؟", a: "نعم، صُمِّم محاسب اي للمشاريع الصغيرة والمتوسطة. الواجهة بسيطة ولا تحتاج خبرة محاسبية. يدعم كلاً من اللغتين العربية والإنجليزية." },
  ...
  { q: "ما الفرق بين محاسب اي والبرامج الأخرى مثل Zoho Books وQuickBooks؟", a: "محاسب اي مبنية للسوق العربي من الأساس: ذكاء اصطناعي يقرأ الفواتير بالعربي، امتثال ضريبي مدمج للإمارات، وواجهة مصممة لأصحاب الأعمال العرب." },
];
  ...
  return (
    <div dir="rtl" lang="ar" style={{ fontFamily: "'Cairo', 'Segoe UI', sans-serif", background: "#f8fafc", minHeight: "100vh" }}>
      <nav style={{ background: "#fff", borderBottom: "1px solid #e5e7eb", padding: "14px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <Link href="/" style={{ fontWeight: 800, fontSize: 20, color: "#2563eb", textDecoration: "none" }}>محاسب اي</Link>
