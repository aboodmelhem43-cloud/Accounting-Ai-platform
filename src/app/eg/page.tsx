...
export const metadata: Metadata = {
  title: "برنامج محاسبة لمصر | متوافق مع الفاتورة الإلكترونية ETA | محاسب اي",
  description:
  ...
  openGraph: {
    title: "برنامج محاسبة لمصر | متوافق مع ETA | محاسب اي",
    description:
...
const FAQS = [
  {
    q: "هل محاسب اي متوافق مع منظومة الفاتورة الإلكترونية المصرية (ETA)؟",
    a: "نعم. يدعم محاسب اي إصدار الفواتير الإلكترونية المتوافقة مع متطلبات مصلحة الضرائب المصرية ومنظومة ETA بالتنسيق المطلوب.",
  },
  {
  ...
  },
  {
    ...
    a: "نعم، صُمِّم محاسب اي لأصحاب الأعمال والمنشآت الصغيرة والمتوسطة في مصر. لا تحتاج خبرة محاسبية — الواجهة بسيطة والذكاء الاصطناعي يُبسّط كل العمليات.",
  },
  {
  ...
  {
    q: "ما الفرق بين محاسب اي والبرامج الأخرى المتاحة في السوق المصري؟",
    a: "محاسب اي يدمج الذكاء الاصطناعي في صميم العمل المحاسبي: يقرأ الفواتير تلقائياً، يقترح القيود المحاسبية، ويُجيب عن أسئلتك المالية — بدلاً من مجرد حفظ البيانات.",
  },
];
