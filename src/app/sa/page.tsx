...
export const metadata: Metadata = {
  title: "برنامج محاسبة للسعودية | متوافق مع ZATCA وضريبة القيمة المضافة | محاسب اي",
  description:
  ...
  openGraph: {
    title: "برنامج محاسبة للسعودية | متوافق مع ZATCA | محاسب اي",
    description:
...
const FAQS = [
  {
    q: "هل محاسب اي متوافق مع ZATCA في السعودية؟",
    a: "نعم. يدعم محاسب اي الفاتورة الإلكترونية المتوافقة مع متطلبات هيئة الزكاة والضريبة والجمارك (ZATCA) مع توليد رمز QR الضريبي تلقائياً على كل فاتورة.",
  },
  {
  ...
  },
  {
    ...
    a: "نعم، صُمِّم محاسب اي خصيصاً للمشاريع الصغيرة والمتوسطة في السعودية. لا تحتاج خبرة محاسبية — الذكاء الاصطناعي يُبسّط كل العمليات.",
  },
  {
    q: "كيف تختلف محاسب اي عن QuickBooks وZoho Books؟",
    a: "محاسب اي مبنية من الأساس للسوق السعودي والعربي: واجهة عربية حقيقية، امتثال ZATCA مدمج، ودعم للممارسات المحاسبية المحلية — بدلاً من ترجمة برامج غربية.",
  },
];
