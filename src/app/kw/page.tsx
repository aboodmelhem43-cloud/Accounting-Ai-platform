...
export const metadata: Metadata = {
  title: "برنامج محاسبة للكويت | دعم الدينار الكويتي | محاسباي",
  description:
...
const FAQS = [
  {
    q: "هل محاسباي يدعم الدينار الكويتي؟",
  ...
  },
  {
    ...
    a: "نعم، صُمِّم محاسباي للمنشآت الصغيرة والمتوسطة. الواجهة بسيطة ولا تحتاج خبرة محاسبية — الذكاء الاصطناعي يُبسّط كل العمليات ويقترح التصنيفات الصحيحة.",
  },
  {
  ...
  {
    q: "ما الفرق بين محاسباي والبرامج الأخرى مثل QuickBooks وZoho Books؟",
    a: "محاسباي مبني للسوق العربي من الأساس: ذكاء اصطناعي يقرأ الفواتير العربية، واجهة RTL حقيقية، ودعم كامل للدينار الكويتي — وليس مجرد ترجمة لبرنامج غربي.",
  },
  {
    q: "هل بياناتي المالية آمنة في محاسباي؟",
