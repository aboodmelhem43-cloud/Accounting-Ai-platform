...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "accounting system",
    // English — by region
    "accounting software Middle East",
    "accounting software Saudi Arabia",
    "accounting software Egypt",
    "accounting software UAE",
    "accounting software Jordan",
    "MENA accounting software",
    "arabic accounting software",
    "cloud accounting software MENA",
    // English — compliance
    "ZATCA e-invoice",
    "ZATCA accounting software",
    "ETA Egypt accounting",
    "VAT accounting software",
    "e-invoicing software Saudi Arabia",
    // English — audience
    "accounting software for startups",
    "small business accounting Middle East",
    "accounting firm software",
    "QuickBooks alternative Middle East",
    "QuickBooks alternative Saudi Arabia",
    // Brand
    "mohasabai",
    "محاسب اي",
  ],
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify([
              ...
              },
              {
                ...
                sameAs: [
                  "https://www.linkedin.com/company/mohasabai",
                  "https://x.com/mohasabai",
                  "https://www.facebook.com/mohasabai",
                ],
