...
export const metadata: Metadata = {
  title: "برنامج محاسبة للأردن | متوافق مع JoFotara | ضريبة المبيعات 16% | محاسب اي",
  description:
  ...
  openGraph: {
    title: "برنامج محاسبة للأردن | متوافق مع JoFotara | محاسب اي",
    description:
...
const FAQS = [
  {
    q: "هل محاسب اي متوافق مع منظومة JoFotara في الأردن؟",
    a: "نعم. يدعم محاسب اي إصدار الفواتير الإلكترونية المتوافقة مع متطلبات منظومة JoFotara التابعة لدائرة ضريبة الدخل والمبيعات في الأردن.",
  },
  {
  ...
  },
  {
    ...
    a: "نعم، صُمِّم محاسب اي للمنشآت الصغيرة والمتوسطة. الواجهة بسيطة ولا تحتاج خبرة محاسبية — الذكاء الاصطناعي يُبسّط كل العمليات.",
  },
  {
  ...
  {
    q: "ما الفرق بين محاسب اي والبرامج الأخرى المتاحة في السوق الأردني؟",
    a: "محاسب اي يدمج الذكاء الاصطناعي في صميم العمل المحاسبي: يقرأ الفواتير تلقائياً، يُنشئ القيود المحاسبية، ويُجيب عن أسئلتك المالية — وهو مبني من الأساس للسوق العربي وليس ترجمة لبرنامج غربي.",
  },
];
